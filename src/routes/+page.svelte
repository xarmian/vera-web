        ...
        <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
          ...
          <div class="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
            <div class="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-4">
              <a href="#download" class="btn btn-primary rounded-lg py-3 px-6 text-base font-medium shadow-md">
                Download Now
              </a>
              <a href="/support" class="btn btn-outline rounded-lg py-3 px-6 text-base font-medium">
                Learn More
              </a>
            </div>
          </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 max-w-lg mx-auto flex flex-col items-center">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 w-full max-w-md mx-auto">
          <!-- Android Download -->
          <a href="#" class="btn flex items-center justify-center bg-gray-400 text-white hover:text-white py-3 px-4 rounded-lg shadow-md relative disabled cursor-not-allowed">
        ...
        <div class="mt-8 w-full max-w-md">
          <a href="https://download.getvera.app/vera-wallet-beta-0.1.4.apk" class="btn btn-primary w-full flex items-center justify-center py-3 px-4 rounded-lg shadow-md">
  ...
  <section class="bg-gradient-to-b from-secondary-500 to-secondary-700 py-16 sm:py-24 text-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-10 flex justify-center space-x-6">
        ...
        <a href="https://discord.gg/vnFbrJrHeW" class="text-secondary-200 hover:text-white">
