    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 max-w-lg mx-auto flex flex-col items-center">
        ...
        <div class="mt-8 w-full max-w-md">
          <a href="https://api.voirewards.com/vera-wallet-beta-0.1.4.apk" class="btn btn-primary w-full flex items-center justify-center py-3 px-4 rounded-lg shadow-md">
